package in.paradigmshifters.olivercjoseph.Demo;
...
import in.paradigmshifters.olivercjoseph.Demo.env.Logger;
  ...
  private void openCamera(final int width, final int height) {
    ...
    try {
      ...
      if (ActivityCompat.checkSelfPermission(activity.getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        ActivityCompat.requestPermissions((Activity) activity.getApplicationContext(),
